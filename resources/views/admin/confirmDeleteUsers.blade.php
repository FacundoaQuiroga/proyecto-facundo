                    ...
                    <div class="row">
                        ...
                        <!-- Card image -->
                            <div class="view view-cascade gradient-card-header primary-color">
                                <h2 class="h2-responsive mb-0 font-weight-bold">Editar formulario usuario : {{ $user->name }}</h2>
                            </div>
                            ...
                            <div class="view gradient-card-header primary-color">
                                <div class="container col-md-10 mb-4">
                                    ...
                                    <div class="card card-cascade cascading-admin-card user-card">
                                        ...
                                        <!-- Card Data -->
                                        <form action="{{route('adminUsers.destroyUsers', $user->rut)}}" method="POST">
                                            {{ csrf_field() }}
                                            {{ method_field('DELETE') }}
                                            ...
                                            <button class="mt-3 btn btn-warning" href="/adminUsers" type="" >Cancelar</button>
                                            <!-- Card content -->
                                        </form>
                                    </div>
                                    <!-- Card -->
