                    ...
                    <div class="row">
                        ...
                        <!-- Card image -->
                            <div class="view view-cascade gradient-card-header primary-color">
                                <h2 class="h2-responsive mb-0 font-weight-bold">Restaurar Residente Eliminado</h2>
                            </div>
                                                ...
                                                <table class="table">
                                                    ...
                                                    @foreach($datos as $dato)
                                                        ...
                                                        <tr>
                                                            <td>{{ $dato->nombres }}</td>
                                                            <td>{{ $dato->user_rut }}</td>
                                                            <td><a class="hoverable alert alert-success" href="{{route('admin.recuperarResidente', $dato->user_rut)}}">Restaurar</a></td>
