                                            ...
                                            <div class="card-body card-body-cascade">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <div class="md-form form-sm mb-0">
                                                            <input type="text" id="form12" class="form-control form-control-sm" placeholder="{{ $datoid->user_rut }}" disabled>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="md-form form-sm mb-0">
                                                            <input type="text" id="form5" class="form-control form-control-sm" placeholder="{{ $datoid->nombres }}" disabled>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="md-form form-sm mb-0">
                                                            <input type="text" id="form5" class="form-control form-control-sm" placeholder="{{ $datoid->apellidos }}" disabled>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4 col-md-12">
                                                        ...
                                                        <div class="md-form form-sm mb-0">
                                                            <input type="text" id="form7" class="form-control form-control-sm" placeholder="{{ $datoid->comuna }}" disabled>
                                                    ...
                                                    <div class="col-lg-4 col-md-6">
                                                        ...
                                                        <div class="md-form form-sm mb-0">
                                                            <input type="text" id="form8" class="form-control form-control-sm" placeholder="{{ $datoid->sector }}" disabled>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4 col-md-4">
                                                        ...
                                                        <div class="md-form form-sm mb-0">
                                                            <input type="text" id="form12" class="form-control form-control-sm" placeholder="{{ $datoid->fecha_actualizacion }}" disabled>
                                                    ...
                                                    <div class="col-lg-4 col-md-4">
                                                        ...
                                                        <div class="md-form form-sm mb-0">
                                                            <input type="text" id="form13" class="form-control form-control-sm" placeholder="{{ $datoid->fecha_certificado }}" disabled>
